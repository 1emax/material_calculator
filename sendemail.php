...
if(!$_POST['company_name'] || $_POST['company_name'] == '') $message .= '<tr><td><strong>Компания</strong></td><td>'.$_POST['company_name'].'</td></tr>';
...
<tr><td><strong>Заезд в Москву</strong></td><td>'.$_POST['moskow_way'].'</td></tr>
<tr><td><strong>Адрес доставки</strong></td><td>'.$_POST['deliv_address'].'</td></tr>
</table>';

$message .= '<br><br>' . $_POST['table'];
$message .= '<br><br> Коментарий к заказу: ' . $_POST['comment'];
$message .= '</body></html>';
